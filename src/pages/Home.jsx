...
const Home = () => {
  ...
  const { GROUPS, FEEDBACKS, LECTURES, CURRICULA, STUDENTS } = Constants
  return (
    <div>
      ...
      <Button
        variant="default"
        onClick={() => open(CURRICULA, { state: { name: 'jon' } })}
      >
        Curricula
      </Button>
      <Button
        variant="default"
        onClick={() => open(GROUPS, { state: { name: 'jon' } })}
      >
        Groups
      </Button>
      <Button variant="default" onClick={() => open(FEEDBACKS)}>
        Feedbacks
      </Button>
      <Button variant="default" onClick={() => open(LECTURES)}>
        Lectures
      </Button>
      <Button variant="default" onClick={() => open(STUDENTS)}>
        students
      </Button>
    </div>
  )
